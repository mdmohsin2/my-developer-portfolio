        ...
        <div>
            <section className="dark:bg-gray-800 dark:text-gray-100">
                <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50">Website Name : It Institute</h2>
                        <p className="max-w-3xl mx-auto mt-4 text-xl text-center  dark:text-gray-400">
                            <a className='text-cyan-400' href='https://assignment-10-b8e77.web.app/' target='_blank'>Live Website</a> ||
                            <a className='text-cyan-400' href='https://github.com/mdmohsin2/It-Instituue-Client-Side' target='_blank'> Github (Client side)</a> ||
                            <a className='text-cyan-400' href='https://github.com/mdmohsin2/It-Institute-Server-Side' target='_blank'> Github (Server side)</a></p>
                    </div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                            ...
                            <div className="mt-12 space-y-12">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 dark:text-gray-400">Users Can Choose from a variety of available courses and parse courses.</p>
                                    </div>
                                </div>
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-2 dark:text-gray-400">Users Can login to the website with google and github.</p>
                                    </div>
                                </div>
                                <div className="flex">
                                    <div className="flex-shrink-0">
                        ...
                        <div aria-hidden="true" className="mt-10 lg:mt-0">
                            <img src='https://i.ibb.co/xFSCYM0/institute.jpg' alt="" className="h-[450px] mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
                        </div>
                    </div>
                </div>
            </section>
